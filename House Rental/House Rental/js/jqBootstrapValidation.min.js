    ...
    options: {
      ...
      init: function (a) {
        ...
        return u(e).bind("submit", function (a) {
          ...
          var l = u(this), t = l.parents(".control-group").first(), i = t.find(".help-block").first(),
            r = l.parents("form").first(), n = [];
          ...
          u.each(n, function (a, t) {
            var i = l.data("validation" + t + "Message"), e = void 0 !== i, n = !1;
            ...
            return l.triggerHandler("change.validation", {submitting: !0})
        ...
        return this.each(function () {
          var a = u(this), e = a.parents(".control-group").first(), t = e.find(".help-block").first();
        ...
        return this.each(function (a, e) {
          var t = u(e), i = t.attr("name"), n = t.triggerHandler("validation.validation", {includeEmpty: !0});
        ...
        var t = [];
        return this.each(function (a, e) {
          t = t.concat(u(e).triggerHandler("getValidators.validation") ? u(e).triggerHandler("validation.validation", {submitting: !0}) : [])
        }), 0 < t.length
      }, override: function (a) {
        t = u.extend(!0, t, a)
      }
